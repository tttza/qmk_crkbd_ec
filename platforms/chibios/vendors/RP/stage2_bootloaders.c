...
#if defined(RP2040_FLASH_OLD_DEFAULT)

// Boot2 blob from the legacy rp2040 branch (bs2_default_padded_checksummed.S).
// This matches the known-good Xiao RP2040 behavior.
...
#elif defined(RP2040_FLASH_AT25SF128A)
