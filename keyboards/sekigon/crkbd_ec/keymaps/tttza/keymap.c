...
const uint16_t keymaps[DYNAMIC_KEYMAP_LAYER_COUNT][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                  KC_LGUI, _______,  KC_SPC,     LGUI_T(KC_F13), _______, KC_DEL
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT, XXXXXXX, XXXXXXX,  KC_F15, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, LALT_T(KC_ENT), WSEL, KC_PGUP, KC_PGDN,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                  KC_LGUI, _______, LGUI_T(KC_F13),     KC_ENT, _______, WSEL
                                      //`--------------------------'  `--------------------------'
  ),
