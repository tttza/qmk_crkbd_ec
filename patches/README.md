...
## パッチ一覧
- patches/common/0001-split-and-matrix-adjustments.patch
- patches/common/0002-ws2812-compat.patch
- patches/common/0003-uf2conv-local-changes.patch
- patches/common/0004-pico-boot-and-wear-leveling.patch

## 適用方法
```
git apply patches/common/0001-split-and-matrix-adjustments.patch
git apply patches/common/0002-ws2812-compat.patch
git apply patches/common/0003-uf2conv-local-changes.patch
...
```
# 例: split/matrix
git diff upstream/master -- quantum/matrix_common.c quantum/split_common/split_util.c > patches/common/0001-split-and-matrix-adjustments.patch
