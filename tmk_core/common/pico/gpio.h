...
#define setPinInput(pin) (gpio_init(pin), gpio_set_dir(pin, GPIO_IN))
#define setPinInputHigh(pin) (gpio_init(pin), gpio_set_dir(pin, GPIO_IN), gpio_pull_up(pin))
#define setPinInputLow(pin) (gpio_init(pin), gpio_set_dir(pin, GPIO_IN), gpio_pull_down(pin))
#define setPinOutput(pin) (gpio_init(pin), gpio_set_dir(pin, GPIO_OUT))
